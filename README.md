...
В LINUX можнос осздать процесс исключительно из другого процесса. Процесс создается путем копирования существующего процесса. Процесс создания нового процесса называется **fork**   
...
**wait** - системный вызов, который считывает код возврата
