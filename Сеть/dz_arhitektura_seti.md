...
### Настройка NAT и маршрутизации на сервере inetRouter
...
### Настройка статических маршрутов на остальных устройствах
1. Так как у нас нет маршрутов до узлов в сети, то нет сетевой связанности с хостами в сети
```
root@office1Server:/home/vagrant# ping 192.168.1.2
ping: connect: Network is unreachable
```
Нам нужно настроить маршруты, делаем на  office1Server default маршрут в сторону office1Router
```
